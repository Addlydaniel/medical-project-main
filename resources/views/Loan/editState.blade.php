                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                <div class="card">
                                    ...
                                    <form class="form-horizontal" method="post" action="{{ URL('/updateState/' )}}">
                                   @csrf
                                            
											<div class="mb-3">
                                                <label for="formrow-firstname-input" class="form-label">State ID</label>
                                             
                                                <input type="text" class="form-control" id="StateID" name="StateID" value="{{$state->StateID}}" >
                                            </div>
											<div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"  id="StateCode" name="StateCode" value="{{$state->StateCode}}" >
                                            </div>
