    ...
    <div class="container-fluid">
        ...
        <div class="row" >
            <div class="col-10">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Group Loan</h4>
            ...
            <div class="col-2">
              <a href="{{URL('/addGroupLoan')}}"> <button type="button" class="btn btn-success waves-effect waves-light">Add Group Loan</button></a>
		...
		@endif
                        ...
                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                             @foreach($grouploan as $grouploan_data)
                            <tr>
							<td>{{$grouploan_data->id}}</td>
                            <td>{{$grouploan_data->GroupName}}</td>
                            <td>{{$grouploan_data->ClientName}}</td>
                            <td>{{$grouploan_data->GroupLoanAmnt}}</td>
                            <td>{{$grouploan_data->GroupInterestValue}}</td>
                            <td>{{$grouploan_data->GroupTensure}}</td>
                            <td>{{$grouploan_data->GroupROI}}</td>
                            <td>{{$grouploan_data->monthlyPaid}}</td>
                            <td>{{$grouploan_data->scheme_type_name}}</td>
                              ...
                              <td class="center">
                                  <div class="btn-toolbar row-action">
                                    <div class="btn-group">
                                    <a class="btn btn-primary"href="{{ URL('/editgroupLoan/'.$grouploan_data->id )}}"title="Edit">Edit</a>
                                    <a class="btn btn-danger"href="{{ URL('/deleteGroupLoan/'.$grouploan_data->id )}}"title="View">Delete</a>
