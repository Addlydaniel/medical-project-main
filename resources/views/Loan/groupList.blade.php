...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row" >
            ...
            <div class="col-2">
              <a href="{{URL('/addGroupList')}}"> <button type="button" class="btn btn-success waves-effect waves-light">Add Group Loan</button></a>
		...
		@endif
                        ...
                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                             @foreach($grouplist as $groupgrouplist_data)
                            <tr>
							<td>{{$groupgrouplist_data->LoanProposalNo}}</td>
							<td>{{$groupgrouplist_data->LoanApplied}}</td>
							<td>{{$groupgrouplist_data->LoanAppliedDate}}</td>
							<td>{{$groupgrouplist_data->LoanPurpose}}</td>
							<td>{{$groupgrouplist_data->LoanApprovalStatus}}</td>
                              ...
                              <td class="center">
                                  <div class="btn-toolbar row-action">
                                    <div class="btn-group">
                                    <a class="btn btn-primary"href="{{ URL('/editgroupList/'.$groupgrouplist_data->id )}}"title="Edit">Edit</a>
                                    <a class="btn btn-danger"href="{{ URL('/deleteGroupList/'.$groupgrouplist_data->id )}}"title="Delete">Delete</a>
