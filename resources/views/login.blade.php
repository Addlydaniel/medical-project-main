                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-sucess p-4">
                                            ...
                                            <p style="color:white">Welcome to BHGALA</p>
                                        </div>
                                    </div>
                                ...
                                <div class="p-2">
                                    ...
                                    @csrf
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="userEmail" id="userEmail" placeholder="Enter Phone Number">
                                        </div>
