                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                <div class="card">
                                    ...
                                    <form class="form-horizontal" method="post" action="{{ URL('/submitCity/' )}}">
                                   @csrf
											<div class="mb-3">
                                                <label for="formrow-firstname-input" class="form-label">City Name</label>
                                             
                                                <input type="text" class="form-control" id="city_name" name="city_name" value="{{old('city_name')}}" placeholder="City Name" required="">
                                            </div>
											
											<div class="mb-3">
                                                <label for="formrow-firstname-input" class="form-label">District Name</label>
                                             
                                                <input type="text" class="form-control" id="district_name" name="district_name" value="{{old('district_name')}}" placeholder="district_name" required="">
                                            </div>
