                                ...
                                <div class="card">
                                   ...
                                   @csrf
									...
									<div class="mb-3">
										...
										<input type="hidden" class="form-control" id="id" name="id" value="{{$district->id}}" placeholder="District Name" required="">
										<input type="text" class="form-control" id="district_name" name="district_name" value="{{$district->district_name}}" placeholder="Qualification Name" required="">
									</div>
