...
class HospitalController extends Controller
{
    ...
    public function addHospital() {
       ...
       $category=Category::get();
        ...
        return view('hospital/addHospital')->with('hos',$hos)->with('city',$city)->with('district',$district)->with('hospital_category',$hospital_category)->with('qualification',$qualification)->with('category',$category);
    }
	...
	public function addBranch() {
        ...
        $district=District::get();
        $city=City::get();
        return view('hospital/addBranch')->with('district',$district)->with('branch',$branch)->with('city',$city);
    }
...
public function viewDoctor($ID){
        $doctor=Doctor::where([['doctor.id',$ID]])->first();
        return view('hospital/viewDoctor')->with('doctor',$doctor);
   }
